...
function Page() {
  return (
    <Section>
      <Container size="md">
        <Heading as="h1" className="text-center mb-12">Neuigkeiten / Journal</Heading>
