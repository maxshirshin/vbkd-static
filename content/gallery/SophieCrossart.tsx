            ...
            <MultiCol>
              ...
              <Col>
                ...
                <Prose className="text-center text-sm md:text-sm">
                  <p>
                    <strong>
                      Sophie ist eine botanische Künstlerin und Illustratorin, die mit
                      Aquarellfarben auf Papier und
                    </strong>
                    <br />
                    <strong>Pergament malt.</strong>
                  </p>
                  <p>
                    In unserem modernen digitalen Zeitalter ist das Malen der Natur ihre Art, ein
                    Gefühl von Authentizität, Verbundenheit und Gewissheit im Leben zu bewahren. Im
                    Mittelpunkt ihrer Arbeit steht ihre Faszination für komplizierte natürliche
                    Details. Sie beobachtet und isoliert diese sorgfältig in ihre Bilder, um die
                    Erfüllung einzufangen, die wir erfahren, wenn wir auf etwas scheinbar
                    Unbedeutendes stoßen, das sich aber als liebevoll schön herausstellt.
                  </p>
                  <p>
                    <br />
                    ...
                    überträgt, möchtet
                    <br />
                    Sophie sie zu eine bleibende Erfahrung und Quelle der Vertrautheit und
                    Inspiration machen. Indem
                    <br />
                    sie ihre botanischen Motive gelegentlich mit Gegenständen aus der
                    Naturgeschichte kombiniert,
                    <br />
                    erforscht sie die Beziehung der Menschheit zu den größeren Themen Wandel und
                    Zeit. Ihre eigene
                    <br />
                    Interpretation von „Memento Mori“ plädiert für die Erfahrung der Schönheit des
                    Lebens statt der
                    <br />
                    Angst für Verlust. Momentan arbeitet Sie an eine Serie der die grandiose
                    Strukturen des Weltraum
                    <br />
                    verbindet mit die Einzigartigkeit der irdische Natur — der Natur als Teil des
                    Alls.
                  </p>
                  <p>
                    <br />
                    Sophie studierte Kunstgeschichte in den Niederlanden und Deutschland und
                    promovierte in
                    <br />
                    München. Ihre Werke sind geprägt von ihrem akademischen Forschung nach der
                    historischen
                    <br />
                    Abbildung des Alltags und der Natur. Sophie lebt in Heidelberg, Deutschland, und
                    arbeitet sowohl
                    <br />
                    an kommerziellen als auch privaten Aufträgen und Zusammenarbeiten. Ihre Werke
                    werden
                    <br />
                    weltweit gesammelt.&nbsp;
                  </p>
                  <p>
                    ...
                    <br />
                    E-mail:{' '}
                    <a href="mailto:contact@sophiecrossart.com">contact@sophiecrossart.com</a>
                  </p>
                </Prose>
              </Col>
            </MultiCol>
