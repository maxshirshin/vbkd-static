    ...
    <Content>
      ...
      <Prose className="text-center text-sm md:text-sm">
        <p>
          ...
          überträgt, möchtet
          <br />
          Sophie sie zu eine bleibende Erfahrung und Quelle der Vertrautheit und Inspiration machen.
          Indem
          <br />
        ...
        <p>
          ...
          <br />
          Abbildung des Alltags und der Natur. Sophie lebt in Heidelberg, Deutschland, und arbeitet
          sowohl
          <br />
