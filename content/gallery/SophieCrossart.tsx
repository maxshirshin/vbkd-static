      ...
      <Container>
        ...
        <Prose className="text-center text-sm md:text-sm">
          <p>
            ...
            überträgt, möchtet
            <br />
            Sophie sie zu eine bleibende Erfahrung und Quelle der Vertrautheit und Inspiration
            machen. Indem
            <br />
            sie ihre botanischen Motive gelegentlich mit Gegenständen aus der Naturgeschichte
            kombiniert,
            <br />
            erforscht sie die Beziehung der Menschheit zu den größeren Themen Wandel und Zeit. Ihre
            eigene
            <br />
            Interpretation von „Memento Mori“ plädiert für die Erfahrung der Schönheit des Lebens
            statt der
            <br />
            Angst für Verlust. Momentan arbeitet Sie an eine Serie der die grandiose Strukturen des
            Weltraum
            <br />
