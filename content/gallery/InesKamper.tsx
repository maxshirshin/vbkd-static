  ...
  return (
    <>
      <Section className="pb-0 pt-32">
        <Container>
          <Heading as="h1" className="mb-0 text-center">{ "Ines Kamper" }</Heading>
        </Container>
      </Section>
          ...
          <MultiCol>
            ...
            <Col>
              ...
              <Prose className="text-center text-sm md:text-sm">
                ...
                <p dangerouslySetInnerHTML={{ __html: `Instagram: <a className="text-primary hover:underline" target="_blank" href="https://www.instagram.com/ines_kamper2020">@ines_kamper2020</a>` }} />
                <p dangerouslySetInnerHTML={{ __html: `E-Mail: <a href="mailto:ines_witt@yahoo.de">ines_witt@yahoo.de</a>` }} />
              </Prose>
            </Col>
