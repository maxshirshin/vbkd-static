              ...
              <Prose className="text-center text-sm md:text-sm">
                ...
                <p>
                  <i className="text-primary-dark block my-4 border-l-2 pl-4 border-primary">
                    ...
                    belegte, fühlte es sich an, wie nach Hause zu kommen. Etwas Magisches passierte
                    in mir an diesem Tag und ich wusste, dass Botanische Illustrationen mit meiner
                    Zukunft verbunden sein würden. Botanische Kunst und Illustrationen verbinden
                    meinen Kopf mit meinem Herzen. Es gibt nichts Schöneres für mich, als mit den
                    Beinen zu baumeln und über den Blütenbau eines Doldenblütlers nachzudenken. Mit
                    dem Pinsel in der Hand bin ich glücklich. Ich bin davon überzeugt, dass in jedem
                    Menschen ein Künstler schlummert, den man einfach aufwecken muss.
                  </i>
                </p>
                <p>
                  <i className="text-primary-dark block my-4 border-l-2 pl-4 border-primary">
