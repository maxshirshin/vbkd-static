  ...
  return (
    <>
      <Section className="pb-0 pt-32">
        <Container>
          <Heading as="h1" className="mb-0 text-center">{ "Dr. Sabine Loos" }</Heading>
        </Container>
      </Section>
          ...
          <MultiCol>
            ...
            <Col>
              ...
              <Prose className="text-center text-sm md:text-sm">
                <p dangerouslySetInnerHTML={{ __html: `Aquarell auf Pergament` }} />
                <p dangerouslySetInnerHTML={{ __html: `Orientalische Nieswurz (Helleborus orientalis)` }} />
              </Prose>
            </Col>
            ...
            <Col>
              ...
              />
              <Prose className="text-center text-sm md:text-sm">
                <p dangerouslySetInnerHTML={{ __html: `Efeu (Hedera helix)` }} />
              </Prose>
            </Col>
            ...
            <Col>
              ...
              />
              <Prose className="text-center text-sm md:text-sm">
                <p dangerouslySetInnerHTML={{ __html: `Alpen-Mannstreu (Eryngium alpinum)` }} />
                <p dangerouslySetInnerHTML={{ __html: `<strong>Sabine Loos lebt seit 1995 mit ihrer Familie im idyllischen Rudolstadt an der Saale, einem der Lieblingsorte Friedrich Schillers. Hier fertigt sie in ihrem idyllisch gelegenen Atelier unterhalb der Heidecksburg Botanische Illustrationen und Botanische Kunst.</strong>` }} />
                <p dangerouslySetInnerHTML={{ __html: `<i className="text-primary-dark block my-4 border-l-2 pl-4 border-primary">Ich studierte Biologie an der altehrwürdigen Friedrich-Schiller-Universität in Jena und an der ETH Zürich und promovierte in meinem Hauptfach Mikrobiologie über Sekundärmetaboliten in filamentösen Pilzen.</i>` }} />
                <p dangerouslySetInnerHTML={{ __html: `<i className="text-primary-dark block my-4 border-l-2 pl-4 border-primary">Mein Nebenfach Botanik faszinierte mich ebenfalls. Besonders die Pharmakologie natürlicher pflanzlicher Sekundärmetabolite zog mich in ihren Bann. Als ich einen Anfängerkurs für Botanische Illustration bei Katja Katholing-Bloss belegte, fühlte es sich an, wie nach Hause zu kommen. Etwas Magisches passierte in mir an diesem Tag und ich wusste, dass Botanische Illustrationen mit meiner Zukunft verbunden sein würden. Botanische Kunst und Illustrationen verbinden meinen Kopf mit meinem Herzen. Es gibt nichts Schöneres für mich, als mit den Beinen zu baumeln und über den Blütenbau eines Doldenblütlers nachzudenken. Mit dem Pinsel in der Hand bin ich glücklich. Ich bin davon überzeugt, dass in jedem Menschen ein Künstler schlummert, den man einfach aufwecken muss.</i>` }} />
                <p dangerouslySetInnerHTML={{ __html: `<i className="text-primary-dark block my-4 border-l-2 pl-4 border-primary">Nach vielen Stunden des Selbststudiums und Online-Kursen, die mir viel Freude bereiteten, beschloss ich, meine künstlerischen Fähigkeiten weiter zu vertiefen. &nbsp;Seitdem studiere ich Botanische Illustration im Diplomstudiengang am Royal Botanical Garden Edinburgh. Den werde ich 2024 abschließen. Mein Herzensanliegen ist es, die historischen Wurzeln der Botanischen Illustration in Deutschland wieder zu beleben und die Botanische Kunst in Deutschland wieder aufblühen zu lassen.</i>` }} />
                <p dangerouslySetInnerHTML={{ __html: `<i className="text-primary-dark block my-4 border-l-2 pl-4 border-primary">Herzliche Grüße</i>` }} />
                <p dangerouslySetInnerHTML={{ __html: `<i className="text-primary-dark block my-4 border-l-2 pl-4 border-primary">Aus dem Botanischen Atelier unter dem Schlosshain</i>` }} />
                <p dangerouslySetInnerHTML={{ __html: `<i className="text-primary-dark block my-4 border-l-2 pl-4 border-primary">Eure Sabine</i>` }} />
              </Prose>
            </Col>
            ...
            <Col>
              ...
              />
              <Prose className="text-center text-sm md:text-sm">
                <p dangerouslySetInnerHTML={{ __html: `Website: <a className="text-primary hover:underline" target="_blank" href="https://www.sabine-loos.de/">www.sabine-loos.de</a><br>Instagram: <a className="text-primary hover:underline" target="_blank" href="https://instagram.com/losbine">@losbine</a><br>Facebook: <a className="text-primary hover:underline" target="_blank" href="https://www.facebook.com/drsabineloos">https://www.facebook.com/drsabineloos</a><br>TikTok: <a className="text-primary hover:underline" target="_blank" href="https://www.tiktok.com/@sabineloosartist">@sabineloosartist</a>` }} />
              </Prose>
            </Col>
          </MultiCol>
         </GalleryLightboxWrapper>
