            ...
            <MultiCol>
                ...
                <Prose className="text-center text-sm md:text-sm">
                  ...
                  <p
                    dangerouslySetInnerHTML={{
                      __html: `Orientalische Nieswurz (Helleborus orientalis)`,
                    }}
                  />
                </Prose>
              </Col>
              ...
              <Col>
                ...
                <Prose className="text-center text-sm md:text-sm">
                  ...
                  <p
                    dangerouslySetInnerHTML={{
                      __html: `<strong>Sabine Loos lebt seit 1995 mit ihrer Familie im idyllischen Rudolstadt an der Saale, einem der Lieblingsorte Friedrich Schillers. Hier fertigt sie in ihrem idyllisch gelegenen Atelier unterhalb der Heidecksburg Botanische Illustrationen und Botanische Kunst.</strong>`,
                    }}
                  />
                  <p
                    dangerouslySetInnerHTML={{
                      __html: `<i className="text-primary-dark block my-4 border-l-2 pl-4 border-primary">Ich studierte Biologie an der altehrwürdigen Friedrich-Schiller-Universität in Jena und an der ETH Zürich und promovierte in meinem Hauptfach Mikrobiologie über Sekundärmetaboliten in filamentösen Pilzen.</i>`,
                    }}
                  />
                  <p
                    dangerouslySetInnerHTML={{
                  ...
                  <p
                    dangerouslySetInnerHTML={{
                      __html: `<i className="text-primary-dark block my-4 border-l-2 pl-4 border-primary">Herzliche Grüße</i>`,
                    }}
                  />
                  <p
                    dangerouslySetInnerHTML={{
                      __html: `<i className="text-primary-dark block my-4 border-l-2 pl-4 border-primary">Aus dem Botanischen Atelier unter dem Schlosshain</i>`,
                    }}
                  />
                  <p
                    dangerouslySetInnerHTML={{
                      __html: `<i className="text-primary-dark block my-4 border-l-2 pl-4 border-primary">Eure Sabine</i>`,
                    }}
                  />
                </Prose>
              </Col>
