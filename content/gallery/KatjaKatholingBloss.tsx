  ...
  return (
    <>
      <Section className="pb-0 pt-32">
        <Container>
          <Heading as="h1" className="mb-0 text-center">{ "Katja Katholing-Bloss" }</Heading>
        </Container>
      </Section>
          ...
          <MultiCol>
            ...
            <Col>
              ...
              <Prose className="text-center text-sm md:text-sm">
                ...
                <p dangerouslySetInnerHTML={{ __html: `<strong>Alles begann im Jahr 2008 mit dem spontanem Besuch der Ausstellung “Botanica” im Botanischen Garten in Sydney. Dort begegnete Katja schier unglaublich realistisch und detailliert gezeichneten Pflanzen von botanischen Illustratoren und Künstlern.</strong>` }} />
            ...
            <Col>
              ...
              />
              <Prose className="text-center text-sm md:text-sm">
                <p dangerouslySetInnerHTML={{ __html: `Website: <a className="text-primary hover:underline" target="_blank" href="https://katjakatholing-bloss.com">https://katjakatholing-bloss.com</a>` }} />
                <p dangerouslySetInnerHTML={{ __html: `Instagram: <a className="text-primary hover:underline" target="_blank" href="https://www.instagram.com/katjakatholingbloss">@katjakatholingbloss</a>` }} />
              </Prose>
            </Col>
          </MultiCol>
         </GalleryLightboxWrapper>
