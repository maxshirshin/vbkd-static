      ...
      <Grid contained={false} className="mt-16">
        <Col lg={8} md={12} sm={12}>
          <Prose className="text-sm md:text-sm">
            <p>
              <strong>
                Alles begann im Jahr 2008 mit dem spontanem Besuch der Ausstellung “Botanica” im
                Botanischen Garten in Sydney. Dort begegnete Katja schier unglaublich realistisch
                und detailliert gezeichneten Pflanzen von botanischen Illustratoren und Künstlern.
              </strong>
            </p>
            <p>
            ...
            <p>
              ...
              England, unter anderem bei dem leider bereits verstorbenen Stuart Lafford erhalten.
              Nach mehreren Fortbildungen wurde sie zur Kunstlehrerin für den Bereich Botanische
              Illustration - auf Englisch „Botanical Art“ - am Hereford College of Technology
              berufen.
            </p>
            <p>
