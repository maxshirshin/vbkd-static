  ...
  return (
    <>
      <Section className="pb-0 pt-32">
        <Container>
          <Heading as="h1" className="mb-0 text-center">{ "Sue Hénon" }</Heading>
        </Container>
      </Section>
          ...
          <MultiCol>
            ...
            <Col>
              ...
              <Prose className="text-center text-sm md:text-sm">
                <p dangerouslySetInnerHTML={{ __html: `Fritilla (Fritillaria meleagris) - Schachblume, Buntstift auf Papier` }} />
              </Prose>
            </Col>
            ...
            <Col>
              ...
              />
              <Prose className="text-center text-sm md:text-sm">
                <p dangerouslySetInnerHTML={{ __html: `Sonnenhut Gelb I (Echinacea), Buntstift auf Papier` }} />
              </Prose>
            </Col>
            ...
            <Col>
              ...
              />
              <Prose className="text-center text-sm md:text-sm">
                <p dangerouslySetInnerHTML={{ __html: `Lupinen II (Lupinus), Buntstift auf Papier` }} />
                <p dangerouslySetInnerHTML={{ __html: `<strong>Sue Hénon wurde am 8. Januar 1961 in Hayes, Middlesex, England geboren. Sie lebt seit 1987 in Deutschland und ist mit dem französischen Künstler Sylvain Hénon verheiratet. &nbsp;Gemeinsam betreiben sie das Atelier Hénon in Dieburg, Hessen.</strong>` }} />
                ...
                <p dangerouslySetInnerHTML={{ __html: `<i className="text-primary-dark block my-4 border-l-2 pl-4 border-primary">Warum fasziniert mich Botanische Malerei?</i>` }} />
            ...
            <Col>
              ...
              />
              <Prose className="text-center text-sm md:text-sm">
                <p dangerouslySetInnerHTML={{ __html: `Atelier Hénon, Steinstraße 23, 64807 Dieburg<br><a className="text-primary hover:underline" target="_blank" href="https://www.atelierhenon.de/">www.atelierhenon.de</a><br>Tel: <a href="tel:06071-21613">06071-21613</a>` }} />
