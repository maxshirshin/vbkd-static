      ...
      <Container>
        <GalleryLightboxWrapper>
          <MultiCol>
            <Col>
              <GalleryLightboxItem
                localPreview="gallery/sue-henon/image-1.jpg"
                localFull={'gallery/sue-henon/image-1-full.jpg'}
                alt=""
                title="Fritilla (Fritillaria meleagris) - Schachblume, Buntstift auf Papier"
                width={575}
                height={575}
              />
            ...
            <Col>
              <GalleryLightboxItem
                localPreview="gallery/sue-henon/image-2.jpg"
                localFull={'gallery/sue-henon/image-2-full.jpg'}
                alt=""
                title="Sonnenhut Gelb I (Echinacea), Buntstift auf Papier"
                width={577}
                height={754}
              />
            ...
            <Col>
              ...
              <Prose className="text-center text-sm md:text-sm">
                ...
                <p>
                  <strong>
                    Sue Hénon wurde am 8. Januar 1961 in Hayes, Middlesex, England geboren. Sie lebt
                    seit 1987 in Deutschland und ist mit dem französischen Künstler Sylvain Hénon
                    verheiratet. &nbsp;Gemeinsam betreiben sie das Atelier Hénon in Dieburg, Hessen.
                  </strong>
                </p>
                <p>
                  <i className="text-primary-dark block my-4 border-l-2 pl-4 border-primary">
                    ...
                    liebsten verwende ich Farbstifte, Graphit, Aquarelle, Öl und Drucktechniken. Ich
                    unterrichte Botanische Kunst in meinem Atelier und gebe Workshops in Botanischen
                    Gärten, Schulen und Museen. Neben dem Unterrichten habe ich regelmäßig in
                    Einzel- und Gruppenausstellungen in Großbritannien, Spanien und Deutschland
                    ausgestellt. Auch an Kunstprojekten für Kataloge und Broschüren habe ich
                    gearbeitet. Presseartikel sind in mehreren Zeitungen im In- und Ausland
                    erschienen. &nbsp;Ich war sowohl Preisträger und Jurymitglied von Kunstpreisen
                    Großbritannien und Deutschland. Derzeit bin ich die zweite stellvertretende
                    Vorsitzende des Vereins Botanische Kunst Deutschland e.V., Mitglied der Society
                    of Botanical Artists in Großbritannien, Mitglied des Kunstarchivs Darmstadt und
                    Vorstandsmitglied der Freunde und Förderer Museum Schloss Fechenbach.
                  </i>
                </p>
                <p>
                  <i className="text-primary-dark block my-4 border-l-2 pl-4 border-primary">
                ...
                <p>
                  <i className="text-primary-dark block my-4 border-l-2 pl-4 border-primary">
                    ...
                    hat es in Bezug auf die Botanische Malerei eine Art Renaissance gegeben. Ich
                    habe glücklich beobachtet, wie sie sich entwickelt hat, und es hat mir große
                    Freude bereitet, mit Gleichgesinnten zusammenzuarbeiten und Kontakt mit ihnen zu
                    pflegen. Ich hoffe, dass wir mit der Gründung des VBKD zusammen mit meinen
                    Kollegen andere botanische Kunstinteressierte hier in Deutschland erreichen und
            ...
            <Col>
              <GalleryLightboxItem
                localPreview="gallery/sue-henon/image-4.jpg"
                localFull={undefined}
                alt=""
                title="Instagram: @henonsue"
                width={768}
                height={892}
              />
