            ...
            <MultiCol>
                ...
                <Prose className="text-center text-sm md:text-sm">
                  ...
                  <p
                    dangerouslySetInnerHTML={{
                      __html: `<strong>Daniel Rupić wurde in Berlin als Kind kroatischer Gastarbeiter geboren. Er lebt und arbeitet als Physiotherapeut in Potsdam.</strong>`,
                    }}
                  />
                  <p
                    dangerouslySetInnerHTML={{
                  ...
                  <p
                    dangerouslySetInnerHTML={{
                      __html: `Ich begann alles zu verschlingen über die Kunst des Farbstifts. Autodidaktisch, mit Unmengen von Literatur aus den USA und Grossbritannien sowie dem Internet begann ich zu lernen. Das Feuer für die detaillierte und realistische Botanische Kunst war entfacht.`,
                    }}
                  />
                  <p
                    dangerouslySetInnerHTML={{
                  ...
                  <p
                    dangerouslySetInnerHTML={{
                      __html: `Mir wurde sehr schnell klar, was für eine Diskrepanz zwischen Deutschland und den englischsprachigen Ländern herrscht, was die Botanische Kunst als solches und deren Stellenwert hierzulande angeht. Dabei gab es hier einst großartige Künstler wie Merian, Humboldt und andere mehr.`,
                    }}
                  />
                  <p
                    dangerouslySetInnerHTML={{
                      __html: `Ich fühle mich geehrt als Gründungsmitglied und Vorstand des VBKD beizutragen, die Botanische Kunst auch bei uns wieder sichtbarer zu machen, Gleichgesinnte zu finden und vor allem zu zeigen:`,
                    }}
                  />
                  <p
                    dangerouslySetInnerHTML={{
                      __html: `<strong>Die Botanische Kunst in Deutschland lebt!</strong>`,
                    }}
                  />
                </Prose>
              </Col>
              ...
              <Col>
                ...
                <Prose className="text-center text-sm md:text-sm">
                  <p
                    dangerouslySetInnerHTML={{
                      __html: `Instagram: <a className="text-primary hover:underline" target="_blank" href="https://www.instagram.com/daniel.rupic/">@daniel.rupic</a>`,
                    }}
                  />
                  <p
                    dangerouslySetInnerHTML={{
                      __html: `Website: <a className="text-primary hover:underline" target="_blank" href="http://www.danielrupic.com/">www.danielrupic.com</a>`,
                    }}
                  />
                  <p
                    dangerouslySetInnerHTML={{
                      __html: `E-Mail: <a href="mailto:illustration@danielrupic.com">illustration@danielrupic.com</a>`,
                    }}
                  />
                </Prose>
              </Col>
