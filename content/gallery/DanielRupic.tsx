            ...
            <MultiCol>
              ...
              <Col>
                ...
                <Prose className="text-center text-sm md:text-sm">
                  ...
                  <p>
                    <strong>
                      Daniel Rupić wurde in Berlin als Kind kroatischer Gastarbeiter geboren. Er
                      lebt und arbeitet als Physiotherapeut in Potsdam.
                    </strong>
                  </p>
                  <p>
                    Schon als Kind begeisterte mich die Flora und Fauna meiner familiären Heimat
                    Kroatien. Ich erschnorchelte die Adria, sammelte Bonsai, Sukkulenten,
                    Insektivoren und erbte von meiner Mutter, die Floristin war, ihre Faszination
                    für Pflanzen. Jahre später, mittlerweile Physiotherapeut, begann ich mit der
                    Kamera die Natur zu erfassen und nahm unter anderem an Ausstellungen von Pentax
                    und Olympus teil. Mich begeisterten schon immer die Farben, Formen und Details
                    die man entdecken kann, wenn man sich die Zeit nimmt, die Natur wirken zu
                    lassen. Ich versuchte die Pflanzen perfekt festzuhalten, als Individuen, wie ich
                    sie stets sah.
                  </p>
                  <p>
                    Schließlich befiel mich 2018 eine innere Unruhe. Ich wollte mich den Details,
                    dem Charakter und der Schönheit der Pflanzen irgendwie intensiver annähern,
                    dabei auch kreativer und handwerklicher sein. Die Erinnerungen an meine
                    zeichnerische Jugend wurden wach und auch mein Gefallen an den Malereien
                    Humboldts. So beschloss ich, die Botanik zu illustrieren. Einmal, um meiner
                    Pflanzenliebe einen kreativeren Ausdruck zu verleihen, aber auch als Ausgleich
                    zu meinem Berufsleben.
                  </p>
                  <p>
                    Ich begann alles zu verschlingen über die Kunst des Farbstifts. Autodidaktisch,
                    mit Unmengen von Literatur aus den USA und Grossbritannien sowie dem Internet
                    begann ich zu lernen. Das Feuer für die detaillierte und realistische Botanische
                    Kunst war entfacht.
                  </p>
                  <p>
                    Auf Anregung der großartigen Botanischen Künstlerin Julia Asenbaum bewarb ich
                    mich erstmalig 2020 bei der Society of botanical Arts in London SBA für die
                    Ausstellung Plantae 20 und wurde direkt angenommen, welch Freude und Ehre!
                    Weitere Illustrationen nahmen Teil an Ausstellungen der Colouredpencil Society
                    of UK sowie dem Colored Pencil Magazine.
                  </p>
                  <p>
                    Mir wurde sehr schnell klar, was für eine Diskrepanz zwischen Deutschland und
                    den englischsprachigen Ländern herrscht, was die Botanische Kunst als solches
                    und deren Stellenwert hierzulande angeht. Dabei gab es hier einst großartige
                    Künstler wie Merian, Humboldt und andere mehr.
                  </p>
                  <p>
                    Ich fühle mich geehrt als Gründungsmitglied und Vorstand des VBKD beizutragen,
                    die Botanische Kunst auch bei uns wieder sichtbarer zu machen, Gleichgesinnte zu
                    finden und vor allem zu zeigen:
                  </p>
                  <p>
              ...
              <Col>
                ...
                <Prose className="text-center text-sm md:text-sm">
                  ...
                  <p>
                    E-Mail:{' '}
                    <a href="mailto:illustration@danielrupic.com">illustration@danielrupic.com</a>
                  </p>
                </Prose>
              </Col>
            </MultiCol>
